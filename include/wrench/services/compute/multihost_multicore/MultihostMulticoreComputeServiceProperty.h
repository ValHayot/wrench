...
namespace wrench {
    ...
    */
    ...
    public:
         ...
         *                    striving to have all its tasks run in parallel as
         *                    much as possible and use as many cores as possible.
         *                    This could lead to resource wasted due to task dependencies within
         *                    the job. (default)
         */
